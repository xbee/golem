...
class NodeTasksWidget(QtGui.QWidget):
    ...
    def update_node_view_data(self, node_data_state):
        ...
        # update view
        for t in node_data_state.local_tasks_state_data:
            self.__update_exisiting_row_view(self.local_tasks_table_data[self.task_id_to_row_num_mapping[t]], t,
                                             node_data_state.local_tasks_state_data[t]["taskProgress"])

        for t in node_data_state.remote_chunks_state_data:
            self.__update_exisiting_row_view(self.remote_chunks_table_data[self.chunk_id_to_row_num_mapping[t]], t,
                                             node_data_state.remote_chunks_state_data[t]["chunkProgress"])
