...
# FIXME: potencjalnie mozna tez spiac ze soba managery i wtedy kontrolowac zdalnie wszystkie koncowki i sobie odpalac
# nody w miare potrzeb, ale to nie na najblizsza prezentacje zabawa
class NodesManager:
...
if __name__ == "__main__":
    ...
    simulator = LocalNetworkSimulator(manager, num_nodes, max_local_tasks, max_remote_tasks, max_loc_task_duration,
                                      max_rem_task_duration, max_inner_update_delay, node_spawn_delay)
